...
DATA_FILE_DIR = "./data/studies_by_research_subject_area/"
OUTPUT = "./data/list_of_studies_by_discipline.xlsx"
...
def read_data():
    ...
    for file in os.listdir(DATA_FILE_DIR):
        if file.endswith('.xlsx'):
            ...
            # and then adding the keyword "discipline_"
            new_col = 'discipline_' + str(file)[:-5]
