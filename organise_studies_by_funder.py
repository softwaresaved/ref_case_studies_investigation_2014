...
def clean(dataframe):
    """Collapses the rows to produce a clean dataframe.

    There will be one only instance of each Case Id and in that row there will be
    at least one funder identified
